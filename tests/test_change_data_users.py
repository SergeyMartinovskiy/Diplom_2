...
class TestChangeDataUser:
    ...
    def test_successful_change_email_user(self, create_user):
        data = create_user
    ...
    def test_successful_change_name_user(self, create_user):
        data = create_user
        response_1 = BaseApi.login_user(email=data['email'], password=data['password'])
        token = response_1.json()['accessToken']
        update_data = {
    ...
    def test_successful_change_email_and_name_user(self, create_user):
        data = create_user
        response_1 = BaseApi.login_user(email=data['email'], password=data['password'])
        token = response_1.json()['accessToken']
        update_data = {
